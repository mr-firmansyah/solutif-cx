							...
							<div className="relative flex items-center">
								<Link
									className={cn(
										...
										isActive &&
											"bg-gradient-to-r from-primary to-transparent to-20% text-primary transition-all hover:text-primary-foreground hover:duration-300 hover:to-90% hover:delay-150",
