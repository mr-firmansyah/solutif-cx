...
export function TeamSwitcher({
	...
	return (
		<DropdownMenu>
			<DropdownMenuTrigger
				className="w-full rounded-md ring-ring focus-visible:outline-none focus-visible:ring-2 data-[state=open]:bg-accent"
				disabled
			>
				<div className="flex items-center gap-1.5 overflow-hidden px-2 py-1.5 text-left text-sm transition-all">
					...
					<div className="line-clamp-1 flex-1 pr-2 font-medium">SolutifCX</div>
