      ...
      <Card className="shadow-none rounded-md">
        ...
        <CardContent>
          <section className="grid grid-cols-2 gap-4 capitalize" id="bio">
            <div className="col-span-2 font-semibold text-sm">Informasi Pribadi</div>
            ...
            <div className="col-span-1 flex flex-col gap-2 capitalize">
              <p className="text-muted-foreground text-xs">Nama Gadis Ibu Kandung</p>
            ...
            <div className="col-span-1 flex flex-col gap-2">
              <p className="text-muted-foreground text-xs">Nomor Telepon Rumah</p>
            ...
            <div className="col-span-1 flex flex-col gap-2">
              <p className="text-muted-foreground text-xs">Penghasilan</p>
                <p className="text-sm">{data?.bio?.penghasilan ? new Intl.NumberFormat('id-ID', { style: 'currency', currency: 'IDR' }).format(Number(data.bio.penghasilan)) : "-"}</p>
            </div>
          </section>
        </CardContent>
      </Card>
