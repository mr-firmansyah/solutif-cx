	...
	return (
		<div className={className}>
			<Card className="shadow-none rounded-md">
				...
				<CardContent>
					<section
						className="grid grid-cols-2 gap-4 capitalize font-bold text-sm"
						id="campaign"
					>
						...
						<div className="col-span-2 flex flex-col gap-2">
							<p>Script</p>
							<p className="font-normal text-muted-foreground normal-case">
				...
				<table className="table-auto">
					<tbody>
						<tr>
							...
							<td>:</td>
							<td>
								{format(data?.campaign?.createdAt, "MMMM, dd, yyyy, h:mmaaa") +
									" • " +
						...
						<tr>
							...
							<td>:</td>
							<td>
								{format(data?.campaign?.updatedAt, "MMMM, dd, yyyy, h:mmaaa") +
									" • " +
									(data?.campaign?.updatedBy || "-")}
							</td>
						</tr>
					</tbody>
				</table>
